...
public class GetVehiclesReq {
	...
	public GetVehiclesReq(String url, String key) {
		this.url = url;
		this.key = key;
	}
	...
	public JSONArray execute() throws ClientProtocolException, IOException {
		...
		HttpPost post = new HttpPost(url + "ws/vehicle/list");
	...
	public static void main(String[] args) throws ClientProtocolException, IOException {
		GetVehiclesReq req = new GetVehiclesReq("http://ap3.stc.srv.br/integration/prod/", "fe98fc123c80d7bc1253ea5ca5f834ae");
